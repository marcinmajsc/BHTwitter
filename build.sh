    ...
    --sideloaded)
      ...
      if [ -e ./packages/com.atebits.Tweetie2.ipa ]; then
        ...
        cyan -i packages/com.atebits.Tweetie2.ipa -o packages/BHTwitter-sideloaded --ignore-encrypted \
          -uwf ./packages/com.p2kdev.twitternoads_1.2.6_iphoneos-arm64.deb .theos/obj/debug/keychainfix.dylib .theos/obj/debug/BHTwitter.dylib layout/Library/Application\ Support/BHT/BHTwitter.bundle
